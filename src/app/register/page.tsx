...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            users.push(newUser);
            localStorage.setItem('chromaforge-users', JSON.stringify(users));
            localStorage.setItem('chromaforge-current-user', JSON.stringify(newUser));
            ...
            <div className={styles.authContainer}>
                <div className={styles.authCard}>
                    <div className={styles.authHeader}>
                        ...
                        <p>Start creating stunning photos today</p>
                    </div>
